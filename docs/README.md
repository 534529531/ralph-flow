...
|-----------|-------------|
| [How It Works](how-it-works.md) | Architecture, session events, state management |
| [Commands](commands.md) | All slash commands and log events |
...
2. Custom Workflows (create your first workflow)
...
3. How It Works (understand the internals)
